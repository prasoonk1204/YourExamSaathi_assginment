...
export default function Footer() {
  ...
  return (
    <div className="flex justify-between w-full p-16 border-t border-zinc-400 dark:border-zinc-600 gap-20 h-100">
      <div className="flex flex-col justify-between w-70">
        ...
        <div className="flex gap-1">
          ...
          <div>
            ...
            <h1 className="leading-6 text-3xl font-semibold">
              naval <br /> innovators
            </h1>
          </div>
        </div>
